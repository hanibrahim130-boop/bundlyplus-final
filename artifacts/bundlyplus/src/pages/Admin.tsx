      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-lg glass-card rounded-3xl p-8 sm:p-10 space-y-4 text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Signed in as <span className="font-semibold">{user.email}</span> — this account does not
            have the <code className="px-1 py-0.5 rounded bg-slate-100 dark:bg-slate-800">admin</code>{" "}
            custom claim. Run{" "}
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">Manage products, orders, and customers.</p>
            </div>
          </div>
