  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 flex items-center">
      <div className="max-w-3xl mx-auto text-center w-full">
        ...
        >
          {isAr ? 'شي جديد قادم...' : 'Something new is coming...'}
        </motion.h1>
        ...
        >
          {isAr
            ? 'BundlyPlus على وشك التوسّع إلى ما هو أبعد من الاشتراكات الرقمية. ترقّبوا منتجات حقيقية تصلكم إلى باب البيت قريباً.'
            : 'BundlyPlus is about to grow beyond digital subscriptions. Real products, delivered to your door — coming soon.'}
        </motion.p>
        ...
        >
          ...
          {isAr
            ? 'لن نكشف كل شيء بعد... لكن جهّزوا قائمة رغباتكم.'
            : 'We are not spilling the beans yet… but get your wishlist ready.'}
        </motion.p>
        ...
        >
          ...
          >
            {isAr ? 'تصفّح المتوفر الآن' : 'Browse what is live now'}
